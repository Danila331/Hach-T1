...
func S3DeleteFile(fileName string) error {
	...
	// Создание объекта DeleteObjectInput
	input := &s3.DeleteObjectInput{
		Bucket: aws.String("9ba75d8d-cb603f95-2e74-49c2-9f16-f8359d6dd8d0"), // Ваш bucket
		Key:    aws.String(fileName),                                        // Имя файла для удаления
	}
	...
	fmt.Printf("File %s deleted successfully from bucket %s\n", fileName, "9ba75d8d-cb603f95-2e74-49c2-9f16-f8359d6dd8d0")
	return nil
}
